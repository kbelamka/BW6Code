...
start cmd.exe /C mvn install:install-file -Dfile=bw6-maven-plugin-2.8.1.jar -DpomFile=pom.xml

start cmd.exe /C mvn install:install-file -Dfile=fabric8/fabric8-maven-plugin-4.4.1.jar -DpomFile=fabric8/pom.xml
